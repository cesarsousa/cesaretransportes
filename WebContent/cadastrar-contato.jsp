				...
				<td>
					<ul id="menu">
						<c:if test="${not empty cliente}">
							...
							<li><a href="javascript:document.formOrcamentos.submit();">Meus
									Or&ccedil;amentos</a></li>
							<form action="ClienteOpcaoConsultaServlet" name="formOrcamentos"
								id="formOrcamentos">
								<input type="hidden" name="idCliente"
									value="${cliente.idCliente}" /> <input type="hidden"
									name="opcao" value="5" />
							</form>
							<li><a href="javascript:document.formServicos.submit();">Meus
									Servi&ccedil;os</a></li>
							<form action="ClienteOpcaoConsultaServlet" name="formServicos"
								id="formServicos">
								<input type="hidden" name="idCliente"
									value="${cliente.idCliente}" /> <input type="hidden"
									name="opcao" value="6" />
				...
				<div id="cardIndex">
					...
					<div align="center">
			        	...
			        	<div align="right" style="padding: 10px;">
										<img id="btFecharMapa" src="imagens/iconeFecharMapa.png"
											width="40px" height="40px" class="ponteiro" alt="Fechar Mapa"
											title="Fechar Mapa" />
									</div>
								</c:if>
							</div>
